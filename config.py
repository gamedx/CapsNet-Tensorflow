...
flags.DEFINE_integer('train_sum_freq', 2000, 'the frequency of saving train summary(step)')
flags.DEFINE_integer('val_sum_freq', 1000, 'the frequency of saving valuation summary(step)')
