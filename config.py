...
flags.DEFINE_float('regularization_scale', 12.8, 'regularization coefficient for reconstruction loss, default to 12.8')
...
flags.DEFINE_integer('batch_size_per_gpu', 4, 'batch size on 1 gpu')
